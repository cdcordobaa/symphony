...
hooks:
  after_create: |
    ...
    git clone https://github.com/cdcordobaa/symphony.git .
    # Set the default repo for the gh CLI so PRs don't go to the upstream fork
    gh repo set-default cdcordobaa/symphony
...
5.  Run validation/tests required for the scope.
    ...
    - When finished, test and monitor the implementation with `symphony-claude WORKFLOW.md`.
